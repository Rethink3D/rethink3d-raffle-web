...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8 font-body">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card variant="accent" glow={onlineCount > 0}>
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-sm font-display font-bold text-brand-accent tracking-wider uppercase">
                MONITOR DE CONEXÕES
              </h3>
              <p className="text-[10px] font-mono text-brand-muted uppercase mt-0.5">
            ...
            <div className="flex items-center gap-2 bg-brand-accent/10 border border-brand-accent/30 rounded px-2.5 py-1 text-brand-accent">
      ...
      {error && (
        <div className="p-3.5 bg-brand-danger/10 border border-brand-danger/30 text-brand-danger text-xs font-ui font-semibold tracking-wider rounded uppercase">
          ⚠ {error}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card variant="default">
          ...
          <div className="mt-4 pt-3 border-t border-brand-border/20 text-[10px] font-mono text-brand-muted">
        ...
        <Card variant="secondary" glow={!isLoadingStats && (stats?.totalTickets ?? 0) > 0}>
          <div className="flex justify-between items-start">
            ...
            <div className="p-2 rounded bg-brand-secondary/10 text-brand-secondary border border-brand-secondary/30">
              <Ticket size={20} />
            </div>
          </div>
          <div className="mt-4 pt-3 border-t border-brand-border/20 text-[10px] font-mono text-brand-muted">
        ...
        <Card variant="primary">
          <div className="flex justify-between items-start">
            ...
            <div className="p-2 rounded bg-brand-primary/10 text-brand-primary border border-brand-primary/30">
              <CheckSquare size={20} />
            </div>
          </div>
          <div className="mt-4 pt-3 border-t border-brand-border/20 text-[10px] font-mono text-brand-muted">
                      ...
                      <tr key={c.id} className="hover:bg-brand-surface/30 transition-colors">
                        <td className="p-4">
                          <div className="flex flex-col">
                            ...
                            <span className="text-[10px] text-brand-muted font-mono lowercase">ID: {c.id}</span>
                          </div>
                        </td>
                        <td className="p-4">
                        ...
                        <td className="p-4 text-right">
                          <Link to="/admin/campaigns">
                            <button className="text-[10px] font-mono text-brand-secondary hover:underline cursor-pointer">
                              GERENCIAR
                            </button>
                          </Link>
                        </td>
        ...
        <div className="space-y-4">
          ...
          <Card variant="default">
            <div className="flex flex-col gap-4">
              <div className="text-xs font-mono text-brand-muted leading-relaxed">
              ...
              {activeCampaign ? (
                ...
                <div className="text-xs text-brand-danger font-mono bg-brand-danger/5 border border-brand-danger/25 p-3 rounded">
