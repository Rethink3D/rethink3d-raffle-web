...
type FormStep = 'mission' | 'quiz' | 'feedback';
  ...
  return (
    <div className="space-y-6 font-inter max-w-3xl mx-auto">
      ...
      <Card variant="default">
        {formStep === 'mission' ? (
          <form onSubmit={(isQuizWizard || isFeedbackWizard) ? handleGoToQuizStep : handleFormSubmit} className="flex flex-col gap-4">
            {formIsGlobal && (
              <div className="flex items-center gap-2 bg-cyber-accent/10 border border-cyber-accent/30 rounded p-3 text-xs font-mono text-cyber-accent">
                ...
                {(isQuizWizard || isFeedbackWizard) ? ', junto com todas as perguntas já configuradas.' : '.'}
              </div>
            )}
            ...
            <div className="flex justify-end gap-3 mt-4 border-t border-cyber-border/40 pt-4">
              ...
              <Button
                ...
                variant="primary"
                isLoading={isSaving}
                disabled={(isQuizWizard || isFeedbackWizard) && isLoadingWizardData}
              >
                {(isQuizWizard || isFeedbackWizard)
                  ? isLoadingWizardData
                ...
                <div key={qIndex} className="border border-cyber-border rounded-lg p-4 flex flex-col gap-3 bg-black/20">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5 font-inter">
                      ...
                      >
                        {(Object.keys(feedbackQuestionTypeLabels) as QuestionType[]).map((type) => (
